...
<head>
    ...
    <!-- Nucleo Icons -->
    <link href="{{asset('backend_assets/css/nucleo-icons.css')}}" rel="stylesheet" />
    <!-- CSS Files -->
...
<body class="">
    ...
    -->
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    {{Request::is('shows/create') ? 'active': ''}}">
                            ...
                            <li class="dropdown nav-item">
                                ...
                                <ul class="dropdown-menu dropdown-navbar">
                                    ...
                                    <li class="nav-link"><a href="javascript:void(0)" class="nav-item dropdown-item"
                                            data-toggle="modal" data-target="#logoutModal">Log out</a></li>
                                </ul>
                            </li>
    ...
    <!-- Chart JS -->
    <script src="{{asset('backend_assets/js/plugins/chartjs.min.js')}}"></script>
    <!--  Notifications Plugin    -->
    <script src="{{asset('backend_assets/js/plugins/bootstrap-notify.js')}}"></script>
    <!-- Control Center for Black Dashboard: parallax effects, scripts for the example pages etc -->
    <script src="{{asset('backend_assets/js/black-dashboard.min.js?v=1.0.0')}}"></script>
    <!-- Black Dashboard DEMO methods, don't include it in your project! -->
    <script src="{{asset('backend_assets/demo/demo.js')}}"></script>
    <script>
